...
public class findConditionalOption1Activity extends ActionBarActivity {
    TextView result;
    EditText a;
    EditText b;
    EditText ab;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_conditional_option1);
    }

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        // Inflate the menu; this adds items to the action bar if it is present.
        getMenuInflater().inflate(R.menu.menu_find_conditional_option1, menu);
        return true;
    }
